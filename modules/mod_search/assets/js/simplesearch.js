...
/*
 ...
 simplesearch=$('.simplesearch').data('simplesearch');
 console.log(simplesearch);
 */

// jQuery Plugin for SprFlat admin simplesearch
// Control options and basic function of simplesearch
...
(function($) {
    ...
    // here we go!
    $.simplesearch = function(element, options) {

        // plugin's default options
        var defaults = {
            //main color scheme for simplesearch
    ...
    $.fn.simplesearch = function(options) {
        ...
        return this.each(function() {
            ...
            if (undefined == $(this).data('simplesearch')) {
                var plugin = new $.simplesearch(this, options);

                $(this).data('simplesearch', plugin);
