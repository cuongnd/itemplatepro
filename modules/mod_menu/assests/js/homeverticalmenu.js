//huong dan su dung
/*
 $('.homeverticalmenu').homeverticalmenu();

 homeverticalmenu=$('.homeverticalmenu').data('homeverticalmenu');
 console.log(homeverticalmenu);
 */

// jQuery Plugin for SprFlat admin homeverticalmenu
// Control options and basic function of homeverticalmenu
...
(function($) {
    ...
    // here we go!
    $.homeverticalmenu = function(element, options) {

        // plugin's default options
        var defaults = {
            //main color scheme for homeverticalmenu
    ...
    $.fn.homeverticalmenu = function(options) {

        // iterate through the DOM elements we are attaching the plugin to
        return this.each(function() {

            // if plugin has not already been attached to the element
            if (undefined == $(this).data('homeverticalmenu')) {
                var plugin = new $.homeverticalmenu(this, options);

                $(this).data('homeverticalmenu', plugin);
