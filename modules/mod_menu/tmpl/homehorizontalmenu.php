...
$doc->addLessStyleSheet(JUri::root().'modules/mod_menu/assests/less/homehorizontalmenu.less');
$doc->addScript(JUri::root().'media/system/js/jquery.utility.js');
$doc->addScript(JUri::root().'modules/mod_menu/assests/js/homehorizontalmenu.js');
$id = '';
...
<script type="text/javascript">
    jQuery(document).ready(function ($) {
        $("#mod_menu_<?php echo $module->id ?>").homehorizontalmenu({
