...
$doc->addLessStyleSheet(JUri::root().'modules/mod_menu/assests/less/homepagetoprightmenu.less');
...
$tree_ul_li.='</ul>';
echo  '<div class="mod_menu homepagetoprightmenu '.$class_sfx.'" id="mod_menu_'.$module->id.'">'.$tree_ul_li.'</div>';
